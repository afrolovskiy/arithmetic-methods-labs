...
\hline
\input{standart_mthd_f1.tex} 
\hline
\input{rand_back_mthd_f1.tex} 
\hline
\input{regular_simplex_mthd_f1.tex} 
\hline
\input{deform_simplex_mthd_f1.tex} 
\hline 		
\end{tabular}
\end{center}
...
Метод		&	$x^{*}$	&	$f(x^{*})$  &	количество вычислений функции \\
\hline
\input{standart_mthd_f2.tex} 
\hline
\input{rand_back_mthd_f2.tex} 
\hline
\input{regular_simplex_mthd_f2.tex} 
\hline
\input{deform_simplex_mthd_f2.tex} 
\hline 		
\end{tabular}
\end{center} 
